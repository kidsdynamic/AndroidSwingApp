...
public class FragmentDashboardToday extends ViewFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mViewHello = (TextView) mViewMain.findViewById(R.id.dashboard_today_hello);
        mViewMonster = (ImageView) mViewMain.findViewById(R.id.dashboard_today_monster);
        mViewMessage = (TextView) mViewMain.findViewById(R.id.dashboard_today_message);
